...
--
-- Host: 127.0.0.1
-- Czas generowania: 12 Cze 2019, 22:57
...
('root', '[{\"db\":\"projekt\",\"table\":\"uzytkownicy\"},{\"db\":\"Projekt\",\"table\":\"Uzytkownicy\"}]');
...
('root', '2019-06-12 20:56:55', '{\"lang\":\"pl\",\"Console\\/Mode\":\"collapse\"}');
...
-- Baza danych: `projekt`
--
CREATE DATABASE IF NOT EXISTS `projekt` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci;
USE `projekt`;
...
CREATE TABLE `uzytkownicy` (
  ...
  `Konto` varchar(20) COLLATE utf8mb4_polish_ci NOT NULL
...
INSERT INTO `uzytkownicy` (`ID`, `Email`, `Haslo`, `Konto`) VALUES
(1, 'jessahubert@gmail.com', '$2y$10$2kqFnYDqT3iXclx4C7ccb.90OAOX8BsIPNsGRCrqb4QzZ9N9r8kzu', 'admin'),
(2, 'ebi@ebi.pl', 'latwehaslo', 'admin'),
(3, 'sawelsiwy@wp.pl', '', 'admin'),
(4, 'ebi128@op.pl', '', 'NULL'),
(5, 'jessahubert@gmail.com', '', 'NULL'),
(6, 'jessahubert@gmail.com', '', 'NULL'),
(7, 'ebi128@op.pl', '', 'NULL'),
(8, 'jessahubert@gmail.com', '', 'NULL'),
(9, 'ebi128@op.pl', '', 'NULL'),
(10, 'jessahubert@gmail.com', '', 'NULL'),
(12, 'ebi128@op.pl', '$2y$10$KTtHuQywzOUgd7gCdD4NB.o7/Ni3DCncMNmaz/3sRLLrPpSHFGyCK', 'NULL');
